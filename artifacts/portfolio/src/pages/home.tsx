...
import {
  Activity, ArrowRight, BarChart3, BookOpen, BriefcaseBusiness, CalendarClock, Check, CheckCircle2, ChevronDown,
  ...
  return <div className="qcr">
    ...
    <div className="qcr-main">
      ...
      <main>
        ...
        <section className="qcr-overview"><div className="qcr-section-head"><div><p className="qcr-kicker">At a glance</p><h2>What is being maintained</h2></div><span className="qcr-stamp">record / 2025—present</span></div><div className="qcr-overview-grid"><NetworkDiagram /><ActivityFeed /></div></section>
